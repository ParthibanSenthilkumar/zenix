(function (a) {
    a("body").length && a("body").append('<a href="" target="_blank" id="tgpage" class="d-flex align-items-center justify-content-center" title="Our Official Telegram"></a>');
...
$('#regUsername').on('change keyup', function () {
    var regUsername = $('#regUsername').val();
    $('#regFullname').val(regUsername);
});

$('#regEmail').on('change keyup', function () {
    var regEmail = $('#regEmail').val();
    $('#regEmail1').val(regEmail);
});